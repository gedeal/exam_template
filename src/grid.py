...
class Grid:
    ...
    # Todo - Info messages :
        self.set(37,0,"** Use WASD to move             **")
        self.set(38,1,"** J:Jump  I:list  Q/X:quit  **")
        # self.set(38,2," 'u'   Points")
        self.set(38,2,"** K: Shovel ")
        self.set(38,3,"** I: Fruit basket")
        self.set(38,4, "")
        self.set(38,5, "[K]   Key     : ")
        self.set(38,6, "[T]   Treasure: ")
        self.set(38,7, "")
        self.set(38,8, "      Points  : ")
        self.set(38,9, " ")
        self.set(38,10, " ")
        self.set(38,11," ")
